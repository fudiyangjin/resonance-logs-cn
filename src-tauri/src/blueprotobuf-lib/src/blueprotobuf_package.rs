...
pub struct CameraSchemeCache {
    ...
    pub camera_scheme_dict:
        ::std::collections::HashMap<::prost::alloc::string::String, CameraSchemeInfo>,
}
#[derive(specta::Type, Clone, PartialEq, ::prost::Message)]
...
pub struct ModAttrInfo {
    ...
    pub effect_parameter: ::std::collections::HashMap<u32, ::prost::alloc::string::String>,
}
#[derive(specta::Type, Clone, PartialEq, ::prost::Message)]
...
pub struct ScenePersonalObject {
    ...
    pub personal_obj_data: ::std::collections::HashMap<i64, ServerStateObjectInteractionParam>,
}
#[derive(specta::Type, Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
pub struct PersonalZone {
    ...
    pub fashion_collect_quality_count: ::std::collections::HashMap<i32, FashionQualityCollectInfo>,
    ...
    pub ride_collect_quality_count: ::std::collections::HashMap<i32, RideQualityCollectInfo>,
    #[prost(int32, optional, tag = "20")]
    pub weapon_skin_collect_point: ::core::option::Option<i32>,
...
pub struct LifeProfessionWork {
    ...
    #[prost(message, repeated, tag = "2")]
    pub life_profession_work_history_info: ::prost::alloc::vec::Vec<LifeProfessionWorkInfo>,
}
#[derive(specta::Type, Clone, PartialEq, ::prost::Message)]
...
pub struct MasterModeDungeonInfo {
    #[prost(map = "int32, message", tag = "1")]
    pub master_mode_dungeon_info: ::std::collections::HashMap<i32, SeasonMasterModeDungeonInfo>,
    #[prost(bool, optional, tag = "2")]
...
pub struct SeasonMasterModeDungeonInfo {
    #[prost(map = "int32, message", tag = "1")]
    pub master_mode_diff_info: ::std::collections::HashMap<i32, MasterModeDiffDungeonInfo>,
    #[prost(int64, optional, tag = "2")]
...
pub struct HomelandBaseInfo {
    ...
    #[prost(message, optional, tag = "8")]
    pub home_land_clutter_generation_record:
        ::core::option::Option<HomeLandClutterGenerationRecord>,
    #[prost(message, optional, tag = "9")]
...
pub struct HomeLandClutterGenerationRecord {
    #[prost(map = "int32, message", tag = "1")]
    pub home_land_clutter_record: ::std::collections::HashMap<i32, ClutterGenerationRecord>,
}
#[derive(specta::Type, Clone, PartialEq, ::prost::Message)]
...
pub struct DungeonPioneer {
    #[prost(map = "int32, message", tag = "1")]
    pub completed_target_this_time: ::std::collections::HashMap<i32, CompletedTargetInfo>,
}
#[derive(specta::Type, Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
pub struct DungeonSyncData {
    ...
    #[prost(message, optional, tag = "20")]
    pub random_entity_config_id_info: ::core::option::Option<DungeonRandomEntityConfigIdInfo>,
    #[prost(message, optional, tag = "21")]
...
pub struct Entity {
    ...
    pub magnetic_ride_queue_change_info_dict:
        ::std::collections::HashMap<i64, MagneticQueueAppearInfo>,
}
#[derive(specta::Type, Clone, PartialEq, ::prost::Message)]
...
pub struct HttpCachePhotoInfo {
    #[prost(map = "string, string", tag = "1")]
    pub http_cache_photo_info_dict:
        ::std::collections::HashMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
}
#[derive(specta::Type, Clone, PartialEq, ::prost::Message)]
...
pub struct TempPhotoCache {
    #[prost(map = "string, message", tag = "1")]
    pub temp_photo_cache_dict:
        ::std::collections::HashMap<::prost::alloc::string::String, TempPhotoCacheInfo>,
}
#[derive(specta::Type, Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
pub struct NotifyCommunityHomeLandUnlockedAreasUpdate {
    #[prost(message, optional, tag = "1")]
    pub request: ::core::option::Option<NotifyCommunityHomeLandUnlockedAreasUpdateRequest>,
}
#[derive(specta::Type, Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
impl EErrorCode {
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "ErrUserPlayerNotFurniturePackage" => Some(Self::ErrUserPlayerNotFurniturePackage),
            ...
            "ErrItemToySingleEntUseExceeded" => Some(Self::ErrItemToySingleEntUseExceeded),
            ...
            "ErrItemToySingleCellUseExceeded" => Some(Self::ErrItemToySingleCellUseExceeded),
            "ErrMonthlyCardNotExists" => Some(Self::ErrMonthlyCardNotExists),
            "ErrMonthlyCardDataError" => Some(Self::ErrMonthlyCardDataError),
            "ErrMonthlyCardDayAwardReceived" => Some(Self::ErrMonthlyCardDayAwardReceived),
            ...
            "ErrHomeLandInsufficientAuthority" => Some(Self::ErrHomeLandInsufficientAuthority),
            "ErrHomeLandTransferRequestPending" => Some(Self::ErrHomeLandTransferRequestPending),
            "ErrHomeLandTransferRequestTimeout" => Some(Self::ErrHomeLandTransferRequestTimeout),
            ...
            "ErrHomelandNotOwnerCannotOperate" => Some(Self::ErrHomelandNotOwnerCannotOperate),
            ...
            "ErrHouseIntroductionStatementCD" => Some(Self::ErrHouseIntroductionStatementCd),
            "ErrCommunityBuildInvalidRecipeId" => Some(Self::ErrCommunityBuildInvalidRecipeId),
            "ErrCommunityBuildRecipeIsUnlock" => Some(Self::ErrCommunityBuildRecipeIsUnlock),
            "ErrCommunityBuildMax" => Some(Self::ErrCommunityBuildMax),
            "ErrCommunityBuildNoAuthority" => Some(Self::ErrCommunityBuildNoAuthority),
            "ErrCommunityNotBuildCannotCancel" => Some(Self::ErrCommunityNotBuildCannotCancel),
            ...
            "ErrCommunityBuildCannotAccelerate" => Some(Self::ErrCommunityBuildCannotAccelerate),
            "ErrCommunityBuildAlreadyAccelerate" => Some(Self::ErrCommunityBuildAlreadyAccelerate),
            ...
            "ErrCommunityNotBuildCannotReceive" => Some(Self::ErrCommunityNotBuildCannotReceive),
            "ErrCommunityCanNotBuild" => Some(Self::ErrCommunityCanNotBuild),
            "ErrHomeLandCohabitantLimit" => Some(Self::ErrHomeLandCohabitantLimit),
            "ErrHomeLandRootNotQuitCohabitant" => Some(Self::ErrHomeLandRootNotQuitCohabitant),
            "ErrHomeLandNotOwnerCannotQuitCohabitant" => {
                Some(Self::ErrHomeLandNotOwnerCannotQuitCohabitant)
            }
            "ErrHomeLandCohabitantIsExiting" => Some(Self::ErrHomeLandCohabitantIsExiting),
            "ErrHomeLandCohabitantNotExists" => Some(Self::ErrHomeLandCohabitantNotExists),
            "ErrHomeLandCohabitantExitRequestExists" => {
            ...
            "ErrHomeLandCohabitantNotFriend" => Some(Self::ErrHomeLandCohabitantNotFriend),
            "ErrHomeLandCohabitantFriendLevel" => Some(Self::ErrHomeLandCohabitantFriendLevel),
            ...
            "ErrCommunityWarehouseNoAuthority" => Some(Self::ErrCommunityWarehouseNoAuthority),
            "ErrCommunityWarehouseGridPosItemNoEnough" => {
                Some(Self::ErrCommunityWarehouseGridPosItemNoEnough)
            }
            "ErrHomeLandInsufficientFurniture" => Some(Self::ErrHomeLandInsufficientFurniture),
            "ErrCommunityWarehouseTakeOutCountLimit" => {
            ...
            "ErrHomeLandTaskAlreadyFinished" => Some(Self::ErrHomeLandTaskAlreadyFinished),
            ...
            "ErrCommunityEditorNotFurniture" => Some(Self::ErrCommunityEditorNotFurniture),
            ...
            "ErrCommunityEditorOverMaxGroup" => Some(Self::ErrCommunityEditorOverMaxGroup),
            ...
            "ErrCommunityEditorStructureInGroup" => Some(Self::ErrCommunityEditorStructureInGroup),
            "ErrCommunityEditorGroupNotExist" => Some(Self::ErrCommunityEditorGroupNotExist),
            "ErrCommunityEditorAlreadyExist" => Some(Self::ErrCommunityEditorAlreadyExist),
            ...
            "ErrHomeLandFertilizerMaxNumLimit" => Some(Self::ErrHomeLandFertilizerMaxNumLimit),
            ...
            "ErrHomeLandPickUpSinglePlayerLimit" => Some(Self::ErrHomeLandPickUpSinglePlayerLimit),
            "ErrHomeLandPickUpTotalLimit" => Some(Self::ErrHomeLandPickUpTotalLimit),
            "ErrHomeLandPickUpFlowerNotFinished" => Some(Self::ErrHomeLandPickUpFlowerNotFinished),
            ...
            "ErrAwardConfigContentSizeError" => Some(Self::ErrAwardConfigContentSizeError),
            ...
            "ErrAwardConfigGroupContentEmpty" => Some(Self::ErrAwardConfigGroupContentEmpty),
            ...
            "ErrAwardConfigWeightRateMustOne" => Some(Self::ErrAwardConfigWeightRateMustOne),
            "ErrAwardConfigGroupContentRandomNoMatch" => {
                Some(Self::ErrAwardConfigGroupContentRandomNoMatch)
            }
            "ErrAwardConfigGroupContentError" => Some(Self::ErrAwardConfigGroupContentError),
            "ErrAwardConfigPackageContentRandomNoMatch" => {
            ...
            "ErrAwardConfigProItemRuleNoMatch" => Some(Self::ErrAwardConfigProItemRuleNoMatch),
            "ErrAwardConfigPackageContentEmpty" => Some(Self::ErrAwardConfigPackageContentEmpty),
            ...
            "ErrAwardConfigGroupWeightEmpty" => Some(Self::ErrAwardConfigGroupWeightEmpty),
            ...
            "ErrTeamLeaderIllegalCallOperator" => Some(Self::ErrTeamLeaderIllegalCallOperator),
            ...
            "ErrTeamTargetNoMatchMemberType" => Some(Self::ErrTeamTargetNoMatchMemberType),
            ...
            "ErrProfessionSkillSkinNotActive" => Some(Self::ErrProfessionSkillSkinNotActive),
            ...
            "ErrDungeonChallengeAffixNotFound" => Some(Self::ErrDungeonChallengeAffixNotFound),
            ...
            "ErrFashCollectionScoreNotEnough" => Some(Self::ErrFashCollectionScoreNotEnough),
            "ErrFashCollectionAwardAlreadMonth" => Some(Self::ErrFashCollectionAwardAlreadMonth),
            ...
            "ErrFashionAdvanceAlreadyUnlock" => Some(Self::ErrFashionAdvanceAlreadyUnlock),
            ...
            "ErrCameraWithoutThumbnailOrRender" => Some(Self::ErrCameraWithoutThumbnailOrRender),
            ...
            "ErrLifeProfessionLevelNotEnough" => Some(Self::ErrLifeProfessionLevelNotEnough),
            "ErrLifeProfessionLevelRewardGot" => Some(Self::ErrLifeProfessionLevelRewardGot),
            "ErrInvalidLifeProfessionSpecializationId" => {
            ...
            "ErrLifeProfessionPointNotEnough" => Some(Self::ErrLifeProfessionPointNotEnough),
            "ErrInvalidLifeProfessionTargetId" => Some(Self::ErrInvalidLifeProfessionTargetId),
            "ErrLifeProfessionTargetNotEnough" => Some(Self::ErrLifeProfessionTargetNotEnough),
            "ErrLifeProfessionRewardCanNotGet" => Some(Self::ErrLifeProfessionRewardCanNotGet),
            "ErrLifeProfessionEnergyChange" => Some(Self::ErrLifeProfessionEnergyChange),
            "ErrLifeProfessionRecipeIsUnlock" => Some(Self::ErrLifeProfessionRecipeIsUnlock),
            "ErrLifeProfessionRecipeNotExist" => Some(Self::ErrLifeProfessionRecipeNotExist),
            "ErrLifeProfessionRecipeNotUnlock" => Some(Self::ErrLifeProfessionRecipeNotUnlock),
            "ErrLifeProfessionMaxRDRecipeCount" => Some(Self::ErrLifeProfessionMaxRdRecipeCount),
            "ErrLifeProfessionWorkingNotEnd" => Some(Self::ErrLifeProfessionWorkingNotEnd),
            "ErrLifeProfessionAlreadyWorking" => Some(Self::ErrLifeProfessionAlreadyWorking),
            ...
            "ErrUnionRecruitDescriptionTooLong" => Some(Self::ErrUnionRecruitDescriptionTooLong),
            ...
            "ErrUnionBatchSearchUnionIdsTooMuch" => Some(Self::ErrUnionBatchSearchUnionIdsTooMuch),
            ...
            "ErrUnionBuildingUpgradeNoFinish" => Some(Self::ErrUnionBuildingUpgradeNoFinish),
            ...
            "ErrUnionCrowFuncIllegalFuncPos" => Some(Self::ErrUnionCrowFuncIllegalFuncPos),
            ...
            "ErrFriendlinessLevelLowAwardLevel" => Some(Self::ErrFriendlinessLevelLowAwardLevel),
            ...
            "ErrFriendlinessIllegalAwardLevel" => Some(Self::ErrFriendlinessIllegalAwardLevel),
            "ErrFriendlinessLevelAwardIsEmpty" => Some(Self::ErrFriendlinessLevelAwardIsEmpty),
            ...
            "ErrPictureCallBackJudgeIllegal" => Some(Self::ErrPictureCallBackJudgeIllegal),
            "ErrPictureVerifyNoPass" => Some(Self::ErrPictureVerifyNoPass),
            "ErrPictureVerifyBackParamIllegal" => Some(Self::ErrPictureVerifyBackParamIllegal),
            "ErrPictureCallBackParamIllegal" => Some(Self::ErrPictureCallBackParamIllegal),
            ...
            "ErrPictureNoSetEnvCosSecretKey" => Some(Self::ErrPictureNoSetEnvCosSecretKey),
            "ErrPictureCheckInMachineLocked" => Some(Self::ErrPictureCheckInMachineLocked),
            ...
            "ErrShowPieceRoulettePositionNoSet" => Some(Self::ErrShowPieceRoulettePositionNoSet),
            "ErrShowPieceBeyondOftenUseMaxLen" => Some(Self::ErrShowPieceBeyondOftenUseMaxLen),
            "ErrShowPieceBeyondOftenRoulettePositionNum" => {
            ...
            "ErrProfessionStarConfigNotExist" => Some(Self::ErrProfessionStarConfigNotExist),
            "ErrProfessionStarNodeUnlock" => Some(Self::ErrProfessionStarNodeUnlock),
            "ErrProfessionStarNodeNotUnlock" => Some(Self::ErrProfessionStarNodeNotUnlock),
            "ErrProfessionReplaceSkillNotExist" => Some(Self::ErrProfessionReplaceSkillNotExist),
            "ErrProfessionUpgradeNotGreaterCurLevel" => {
                Some(Self::ErrProfessionUpgradeNotGreaterCurLevel)
            }
            "ErrProfessionProfessionBeForged" => Some(Self::ErrProfessionProfessionBeForged),
            "ErrProfessionSlotTwoNotUnlock" => Some(Self::ErrProfessionSlotTwoNotUnlock),
            "ErrProfessionSkillAlreadyActive" => Some(Self::ErrProfessionSkillAlreadyActive),
            ...
            "ErrAoyiSkillRemodelConfigNotExist" => Some(Self::ErrAoyiSkillRemodelConfigNotExist),
            ...
            "ErrProfessionDungeonNotAllowSwitch" => Some(Self::ErrProfessionDungeonNotAllowSwitch),
            "ErrTalentIllegalTalentPoolId" => Some(Self::ErrTalentIllegalTalentPoolId),
            "ErrTalentBeyondCurTalentMaxPlanNum" => Some(Self::ErrTalentBeyondCurTalentMaxPlanNum),
            ...
            "ErrTalentPassiveTalentListNoEmpty" => Some(Self::ErrTalentPassiveTalentListNoEmpty),
            "ErrTalentIllegalTalentLevel" => Some(Self::ErrTalentIllegalTalentLevel),
            "ErrTalentNoMeetUpgradeCondition" => Some(Self::ErrTalentNoMeetUpgradeCondition),
            "ErrTalentNoSupportDownLevelNow" => Some(Self::ErrTalentNoSupportDownLevelNow),
            "ErrTalentNoMeetPrevTalentLv" => Some(Self::ErrTalentNoMeetPrevTalentLv),
            "ErrTalentNoMeetPrevTalentPoint" => Some(Self::ErrTalentNoMeetPrevTalentPoint),
            "ErrTalentTreeNodeBDExclusive" => Some(Self::ErrTalentTreeNodeBdExclusive),
            "ErrTalentTotalTalentPointNotEnough" => Some(Self::ErrTalentTotalTalentPointNotEnough),
            "ErrTalentPreTalentNodeNotActivated" => Some(Self::ErrTalentPreTalentNodeNotActivated),
            ...
            "ErrChatIllegalPrivateChatTarget" => Some(Self::ErrChatIllegalPrivateChatTarget),
            ...
            "ErrChatWorldChannelIdBeyondMaxId" => Some(Self::ErrChatWorldChannelIdBeyondMaxId),
            ...
            "ErrChatMsgIdMoreThanMaxReadMsgId" => Some(Self::ErrChatMsgIdMoreThanMaxReadMsgId),
            "ErrChatBeyondBlockListLimit" => Some(Self::ErrChatBeyondBlockListLimit),
            "ErrChatWorldChannelIdBeyondMaxNum" => Some(Self::ErrChatWorldChannelIdBeyondMaxNum),
            ...
            "ErrUseSkillFightResInsufficient" => Some(Self::ErrUseSkillFightResInsufficient),
            ...
            "ErrUseSkillEnduranceInsufficient" => Some(Self::ErrUseSkillEnduranceInsufficient),
            "ErrUseSkillStateChange" => Some(Self::ErrUseSkillStateChange),
            "ErrUseSkillClientSkillUuid" => Some(Self::ErrUseSkillClientSkillUuid),
            "ErrFightLogicConditionBlockInvalid" => Some(Self::ErrFightLogicConditionBlockInvalid),
            "ErrFightLogicActionGroupInvalid" => Some(Self::ErrFightLogicActionGroupInvalid),
            "ErrFightLogicConditionNotMatch" => Some(Self::ErrFightLogicConditionNotMatch),
            ...
            "ErrSeasonAchievementHasReceived" => Some(Self::ErrSeasonAchievementHasReceived),
            "ErrSeasonAchievementPrevIdNoReceived" => {
                Some(Self::ErrSeasonAchievementPrevIdNoReceived)
            }
            "ErrSeasonAchievementPrevIdNoExist" => Some(Self::ErrSeasonAchievementPrevIdNoExist),
            ...
            "ErrPersonalAvatarFrameUnearned" => Some(Self::ErrPersonalAvatarFrameUnearned),
            ...
            "ErrPersonalMedalDuplicateValue" => Some(Self::ErrPersonalMedalDuplicateValue),
            ...
            "ErrPersonalPhotoDuplicateValue" => Some(Self::ErrPersonalPhotoDuplicateValue),
            ...
            "ErrSeasonMedalActiveMeetNoEnough" => Some(Self::ErrSeasonMedalActiveMeetNoEnough),
            "ErrSeasonMedalUpgradeMeetNoEnough" => Some(Self::ErrSeasonMedalUpgradeMeetNoEnough),
            ...
            "ErrSeasonMedalUpgradeMoneyNoEnough" => Some(Self::ErrSeasonMedalUpgradeMoneyNoEnough),
            ...
            "ErrInstatallSlotFailedInCombat" => Some(Self::ErrInstatallSlotFailedInCombat),
            ...
            "ErrExchangeBuyCurrencyNoEnough" => Some(Self::ErrExchangeBuyCurrencyNoEnough),
            ...
            "ErrExchangeItemIsNotNoticeShopItem" => Some(Self::ErrExchangeItemIsNotNoticeShopItem),
            "ErrExchangeItemIsPreBuyAlready" => Some(Self::ErrExchangeItemIsPreBuyAlready),
            ...
            "ErrExchangeSaleDiamondNotEnough" => Some(Self::ErrExchangeSaleDiamondNotEnough),
            "ErrExchangeSaleItemNotExists" => Some(Self::ErrExchangeSaleItemNotExists),
            "ErrExchangeBuySaleCurrencyNoEnough" => Some(Self::ErrExchangeBuySaleCurrencyNoEnough),
            ...
            "ErrRideApplyTargetUserNotExist" => Some(Self::ErrRideApplyTargetUserNotExist),
            ...
            "ErrWarehouseGridPosItemNoEnough" => Some(Self::ErrWarehouseGridPosItemNoEnough),
            ...
            "ErrEquipOnCantUsedRecastConsume" => Some(Self::ErrEquipOnCantUsedRecastConsume),
            "ErrEquipWeaponNotEqualProfession" => Some(Self::ErrEquipWeaponNotEqualProfession),
            ...
            "ErrEquipEnchantAlreadyEnchanted" => Some(Self::ErrEquipEnchantAlreadyEnchanted),
            "ErrEquipAnyItemMismatch" => Some(Self::ErrEquipAnyItemMismatch),
            "ErrEquipSlotRefineBlessNumTooMuch" => Some(Self::ErrEquipSlotRefineBlessNumTooMuch),
            ...
            "ErrWeeklyHasRewardProcessAward" => Some(Self::ErrWeeklyHasRewardProcessAward),
            ...
            "ErrWeeklyTowerCannotEnterLayer" => Some(Self::ErrWeeklyTowerCannotEnterLayer),
            ...
            "ErrGlobalConditionNotLuckyValue" => Some(Self::ErrGlobalConditionNotLuckyValue),
...
impl EDisappearType {
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "EDisappearTransferPassLineLeave" => Some(Self::EDisappearTransferPassLineLeave),
            _ => None,
        }
    }
}
...
impl EInteractionAction {
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "EInteractionActionExploreMonsterDeplete" => Some(Self::ExploreMonsterDeplete),
            ...
            "EInteractionActionMoveToInteractionSeat" => Some(Self::MoveToInteractionSeat),
            "EInteractionActionRotateToTarget" => Some(Self::RotateToTarget),
            "EInteractionActionRotateToTargetAndWait" => Some(Self::RotateToTargetAndWait),
            ...
            "EInteractionActionAddClientBuffToTarget" => Some(Self::AddClientBuffToTarget),
            ...
            "EInteractionActionRemoveTargetClientBuff" => Some(Self::RemoveTargetClientBuff),
            ...
            "EInteractionActionTriggerSceneCustomEvent" => Some(Self::TriggerSceneCustomEvent),
            ...
            "EInteractionActionRequestInteractionSeat" => Some(Self::RequestInteractionSeat),
