...
export const historyDpsPlayerColumns = [
  ...
  makeColumn("dps.columns.historyPlayers", "effectiveTotal", "有效伤害", "有效伤害", "显示玩家造成的有效伤害", integer),
  makeColumn("dps.columns.historyPlayers", "effectiveDps", "有效秒伤", "有效秒伤", "显示玩家每秒造成的有效伤害 (EDPS)", fixed1),
...
export const historyDpsSkillColumns = [
  ...
  makeColumn("dps.columns.historySkills", "effectiveTotal", "有效伤害", "有效伤害", "显示技能造成的有效伤害", integer),
  makeColumn("dps.columns.historySkills", "effectiveDps", "有效秒伤", "有效秒伤", "显示技能的每秒有效伤害 (EDPS)", fixed1),
...
export const historyHealPlayerColumns = [
  ...
  makeColumn("dps.columns.historyHealPlayers", "effectiveHeal", "有效治疗", "有效治疗", "显示玩家造成的有效治疗量", integer),
  makeColumn("dps.columns.historyHealPlayers", "ehps", "有效秒疗", "有效秒疗", "显示玩家每秒造成的有效治疗量 (EHPS)", fixed1),
...
export const liveHealPlayerColumns = [
  ...
  makeColumn("dps.columns.liveHealPlayers", "effectiveTotal", "有效治疗", "有效治疗", "显示玩家造成的有效治疗量", integer),
  makeColumn("dps.columns.liveHealPlayers", "effectiveDps", "有效秒疗", "有效秒疗", "显示玩家每秒造成的有效治疗量 (EHPS)", fixed1),
...
export const liveTankedPlayerColumns = [
  ...
  makeColumn("dps.columns.liveTankedPlayers", "effectiveTotal", "有效承伤", "有效承伤", "显示玩家承受的有效伤害", integer),
  makeColumn("dps.columns.liveTankedPlayers", "effectiveDps", "有效秒承伤", "有效秒承伤", "显示玩家每秒承受的有效伤害 (ETPS)", fixed1),
...
export const liveTankedSkillColumns = [
  ...
  makeColumn("dps.columns.liveTankedSkills", "effectiveTotal", "有效承伤", "有效承伤", "显示技能造成的有效承伤", integer),
  makeColumn("dps.columns.liveTankedSkills", "effectiveDps", "有效秒承伤", "有效秒承伤", "显示技能每秒造成的有效承伤 (ETPS)", fixed1),
...
export const historyHealSkillColumns = [
  ...
  makeColumn("dps.columns.historyHealSkills", "effectiveTotal", "有效治疗", "有效治疗", "显示技能造成的有效治疗量", integer),
  makeColumn("dps.columns.historyHealSkills", "effectiveDps", "有效秒疗", "有效秒疗", "显示技能每秒造成的有效治疗量 (EHPS)", fixed1),
