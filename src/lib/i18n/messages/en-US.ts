...
export const enUSMessages = {
  ...
  "loadout.sidebar.label": "Current Loadout",
  "loadout.sidebar.empty": "No loadout",
  "loadout.sidebar.manage": "Manage loadouts",
  "loadout.defaults.new": "New Loadout",
  ...
  "loadout.page.active": "Active",
  "loadout.page.activate": "Switch to this loadout",
  "loadout.page.rename": "Rename",
  "loadout.page.duplicate": "Duplicate",
  "loadout.page.delete": "Delete",
  ...
  "loadout.page.importSuccess": "Import successful",
  "loadout.page.importError": "Import failed: invalid file format",
  "loadout.page.exportSuccess": "Export successful",
  ...
  "monitoring.recovery.recovering":
    "Monitoring settings recovered. Reloading...",
  "monitoring.recovery.errorTitle": "Monitoring settings could not be loaded",
  "monitoring.recovery.errorDescription":
    "Automatic recovery could not finish. Reload the app, or open the log directory for details if the problem continues.",
  "monitoring.recovery.reload": "Reload",
  "monitoring.recovery.openLogs": "Open log directory",
  "monitoring.recovery.noticeTitle": "Monitoring settings were recovered",
  "monitoring.recovery.noticeDescription":
    "The unreadable monitoring files were preserved in the recovery directory below. Other app settings were not changed.",
  "monitoring.recovery.dismiss": "Dismiss recovery notice",
  "routes.tools.loadouts": "Loadouts",
  ...
  "history.detail.breakdown.damageTarget": "Damage target",
  "history.detail.breakdown.healingTarget": "Healing target",
  ...
  "history.timeline.lanes.team": "Team",
  "history.timeline.lanes.selectTeammates": "Teammates",
  ...
  "skillMonitor.profile.pickerDescription":
    "The skill-monitor profile referenced by the active loadout. Switch or manage it here; for more combinations go to the Loadouts page",
  "skillMonitor.profile.deleteConfirm":
    "Delete this skill-monitor profile? Loadouts referencing it will fall back to the first profile.",
  ...
  "monsterMonitor.profile.title": "Profiles",
  "monsterMonitor.profile.pickerDescription":
    "The monster-monitor profile referenced by the active loadout. Switch or manage it here; for more combinations go to the Loadouts page",
  "monsterMonitor.profile.new": "New Profile",
  "monsterMonitor.profile.rename": "Rename",
  "monsterMonitor.profile.delete": "Delete",
  ...
  "monsterMonitor.hp.displayTitle": "HP Bar Display",
  "monsterMonitor.hp.displayDescription":
    "Show the health bar (current/max) for the current attack target.",
  "monsterMonitor.hp.enabled": "Enable HP Bar",
  "monsterMonitor.hp.styleTitle": "HP Bar Panel Style",
  ...
  "monsterMonitor.overlay.hp": "HP Bar Area: {state}",
  ...
  "monsterOverlay.hpGroupTag": "HP Area",
  ...
  "voice.phrases.status.ready": "Generated",
  "voice.phrases.status.stale": "Needs regeneration",
  "voice.phrases.status.pending": "Not generated",
  ...
  "voice.phrases.generate.description":
    "Pick a voice source and phrases to batch-generate the missing broadcast audio (takes effect immediately)",
