export const jaJPMessages = {
  ...
  "history.detail.breakdown.damageTarget": "ダメージ対象",
  "history.detail.breakdown.healingTarget": "回復対象",
  ...
  "history.timeline.lanes.team": "チーム",
  "history.timeline.lanes.selectTeammates": "チームメイト",
  ...
  "monsterMonitor.hp.displayTitle": "HP バー表示",
  "monsterMonitor.hp.displayDescription":
    "現在の攻撃対象の HP バー（現在/最大）を表示します。",
  "monsterMonitor.hp.enabled": "HP バーを有効化",
  "monsterMonitor.hp.styleTitle": "HP バーパネルスタイル",
  ...
  "monsterMonitor.overlay.hp": "HP バーエリア: {state}",
  ...
  "monsterOverlay.hpGroupTag": "HP エリア",
  ...
  "monsterOverlay.placeholder.hp": "HP プレビュー",
  ...
  "voice.phrases.status.ready": "生成済み",
  "voice.phrases.status.stale": "再生成が必要",
  ...
  "voice.phrases.generate.description":
    "音声ソースとフレーズを選んで、未生成の読み上げ音声を一括生成します（生成後すぐに有効）",
